...
import Footer from '../Components1/Footer/Footer1.js'
...
const Watermark = React.lazy(()=>import('../Components1/Watermark/Watermark'))
...
function App() {
  ...
  let landingHTML=<>
    ...
    <main>
      <div className="u-margin-top-xxlarge u-margin-bottom-xxlarge main4">
    <div className="o-wrapper-l">
        <div className="hero flex flex-column">
            <div>
                ...
                Using Smart City application across the world 
                </div>
            </div>
            <div> 
            ...
            <div className="callBox flex">
                <input type="text" placeholder="Person ID" value={receiverID} onChange={e => setReceiverID(e.target.value)} className="form-input"/>
                <button onClick={() => callPeer(receiverID.toLowerCase().trim())} className="primaryButton">Call</button>
            </div>
            <div>
                To call another person, ask them to open the smart city in their browser. <br/>
